...
@Component
class RemoveIfLowerPopupController {
    ...
    fun updateTexts() {
        closeButton.text = currentBundle.getString("removeIfLowerPopup.close")
        okButton.text = currentBundle.getString("removeIfLowerPopup.ok")
        idField.promptText = currentBundle.getString("removeIfLowerPopup.idFieldHint")
        popupLabel.text = currentBundle.getString("removeIfLowerPopup.title")
        popupHintLabel.text = currentBundle.getString("removeIfLowerPopup.idFieldHint")
    }

    @FXML
    fun remove() {
        if (idField.text.toLongOrNull() == null) {
            idField.clear()
            idField.style = "-fx-border-color: red;"
            ...
            commandsService.removeIfLower(idField.text.toLong())
            close()
